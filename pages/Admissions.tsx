    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://res.cloudinary.com/dwoh8qevy/image/upload/v1772789505/SLA_8834_yhvcvo.jpg" 
            ...
            <div className="lg:w-1/2 reveal delay-400">
               <div className="relative p-8">
                  ...
                  <div className="relative rounded-[3.5rem] overflow-hidden shadow-2xl border-b-[12px] border-secondary">
                     <img src="https://res.cloudinary.com/dwoh8qevy/image/upload/v1772789504/IMG_4212_w2h410.jpg" className="w-full h-full object-cover" alt="Student Admissions Interaction" />
